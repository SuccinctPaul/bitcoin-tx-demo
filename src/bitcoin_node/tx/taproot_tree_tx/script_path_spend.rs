...
use crate::bitcoin_node::tx::{dummy_unspent_transaction_output, senders_keys, USER_A_PRIVATE_KEY};
use bitcoin::consensus::encode;
use bitcoin::key::TweakedKeypair;
use bitcoin::sighash::{Prevouts, SighashCache};
use bitcoin::{
    absolute, transaction, Amount, ScriptBuf, Sequence, TapSighashType, Transaction, TxIn, TxOut,
    Witness,
};
